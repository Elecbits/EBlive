               ...
               <div id="tag91" class="col-lg-9 ">
                  ...
                  <div class="panel panel-default">
                     <div id="pb1" class="panel-body" style=" padding: 10px 0px 20px 20px; ">
                        <h3 style=" font-size: 25px;  font-family: 'Roboto', sans-serif; color: #0070ff; margin-top: 14px"><i class="material-icons">new_releases</i>&nbsp; New Arrivals</h3>
                        <hr style="height:1px;border:none;color:#0070ff;background-color:#0070ff;" />
                        <?php newgetpro() ?>
                     </div>
                     <div id="pb1" class="panel-body" style=" padding: 0px 0px 20px 20px; ">
                        <h3 style=" font-size: 25px;  font-family: 'Roboto', sans-serif; color: red; "> <i class="material-icons">trending_up</i>&nbsp Trending Now  </h3>
