...
<tr>
      ...
      <td> <a href="index.php?edit_cat=<?php echo $cat_id ; ?>" style="color: black; "> Edit </a> </td> 
       <td> <a href="delete_cat.php?delete_cat=<?php echo $cat_id ?>" style="color: black; "> Delete </a> </td>      
