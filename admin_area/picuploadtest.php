...
<h3 style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px; text-align: center; ">INSERT THE PRODUCTS IMAGE</h3>
...
<div class="table-responsive " style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px";>
  <table class="table">
       ...
       <form action="index.php?insert_product_pic" method="POST" enctype="multipart/form-data">
...
<?php
   ...
   // $insert_product = "INSERT INTO products (product_image ) VALUES ('$file_tmp')  ";
    ...
    $insert_product = "UPDATE products SET product_image= '$file_name' WHERE product_id = $product_id  ";
