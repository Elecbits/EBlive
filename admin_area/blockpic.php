...
<h3 style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px; text-align: center; ">INSERT THE BLOCK DIAGRAM</h3>
...
<div class="table-responsive " style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px";>
  <table class="table">
       ...
       <form action="index.php?insert_block" method="POST" enctype="multipart/form-data">
...
<?php
   ...
   if(isset($_FILES['uploadedfile'])){
      ...
      if(empty($errors)==true){
         move_uploaded_file($file_tmp,"block_diagram/$file_name");
         echo "Success";
      }else{
         print_r($errors);
      }
   ...
   // $insert_product = "INSERT INTO products (product_image ) VALUES ('$file_tmp')  ";
    ...
    $insert_product = "UPDATE products SET product_block= '$file_name' WHERE product_id = $product_id  ";
