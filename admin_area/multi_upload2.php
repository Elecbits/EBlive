...
<h3 style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px; text-align: center; ">INSERT THE OUTPUT IMAGE2</h3>
...
<div class="table-responsive " style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px";>
  <table class="table">
       ...
       <form action="index.php?insert_output_pic2" method="POST" enctype="multipart/form-data">
...
<?php
  ...
  $insert_product = "UPDATE software SET output2 = '$file_name' WHERE soft_id = $product_id  ";
