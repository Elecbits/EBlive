  ...
  <div class="container">
    ...
    <div  style="background-color: white; ">
      <ul class="nav navbar-nav">
        ...
        <li><a href="cart.php" style="padding:30px 0px 0px 10px; font-family: 'Muli', sans-serif; float:left; color:black; "><strong>&nbspCart :<?php total_items(); ?></strong></a></li>
    ...
    <?php
     ...
     {
      echo "<p style='padding: 10px 0px 0px 10px; '><span class='glyphicon glyphicon-user' style='vertical-align: text-top; padding-right:10px; '> </span><a href='customer/my_account.php 'style='font-family: 'cursive'; float:left; color:black; '>Hi $customer_name</a></p>";    
...
<form class="searchbox"  method="get" action="results.php"  enctype="multipart/form-data"  >
    ...
    <div  class=" col-xs-3" style="float: right; padding-right: 30px; "  >
...
?></a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color: white; padding: 10px 0px 0px 40px; ">
      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li> <a href="contactus.php" style="padding-left: 20px; "><span id="g2" class="glyphicon glyphicon-heart" style="vertical-align: text-top; padding-right:10px;"></span>&nbspContact Us</a> </li>
