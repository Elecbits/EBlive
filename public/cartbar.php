...
<html lang="en" class="no-js">
	...
	<body class="cbp-spmenu-push">
		<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1" style="overflow: scroll;  ">
			<div style="background-color: white; color: black; font-family: 'Muli', sans-serif;   "><strong>Categories</strong><button id="showLeftPush1t">Close</button></div>


			<p style="  background-color: #99ff99; font-size: 16px; font-family: 'Muli', sans-serif;"><a href="all_products.php"  style=" color: black;"  ><strong> ALL PROJECTS </strong></a></p>
     ...
     if (!isset($_SESSION['customer_email'])) {
       ...
       echo "
       <br><p style='padding: 0px 0px 0px 10px;'><span class='glyphicon glyphicon-user' style='vertical-align: text-top; padding-right:10px; font-size:15px; font-family: 'Muli', sans-serif;'> </span>Hi Guest</p>" ; 
     ...
     else
     {
      ...
      $run_name_query = mysqli_query($name_query, $con);
    ...
    <?php
     if (!isset($_SESSION['customer_email'])) {
      ...
      echo "<a href='checkout.php' style='padding:0px 0px 0px 10px; font-size:15px; font-family: 'Muli', sans-serif;'>Login</a> ";
     }
     else
     {
     
      echo "
      <br><br><p style='padding: 0px 0px 0px 10px;' ><span class='glyphicon glyphicon-user' style='vertical-align: text-top;  padding-right:10px; font-size:15px; font-family: 'Muli', sans-serif; '> </span><a href='account.php'>Hi $customer_name</a></p>";    

       echo "<a href='customer/logout.php' style='padding:0px 0px 0px 10px; font-size:15px; font-family: 'Muli', sans-serif;'>Logout</a> ";
...
?>
  ...
  <div class="panel panel-default hidden-xs" >
    ...
    <div class="panel-body">
      ...
      <div class= "col-lg-8 col-xs-12" style="border-style: solid;  border-color: white ; padding: 0px 20px 10px 20px ; " >
       ...
       <strong style="font-size:25px; font-family: 'Muli', sans-serif;"><a href="details1.php?pro_id=<?php echo $pro_id; ?>"><?php echo $product_title; ?></a></strong>
         
      <div style="font-size:13px; font-family: 'Muli', sans-serif;"><?php echo $pro_cat1; ?>,<?php echo $pro_cat2; ?>,  <?php echo $pro_cat3; ?> and  <?php echo $pro_cat4; ?> </div>
       ...
       <a href="kitdetails.php" style="color:#0070FF;">ReadyMade Kit</a>: Plug and play set, 1 pendrive(all softwares and explanatory documents),<a href="gifts.php" style="color:red;" > 1 Special Gift </a><br>
        <a href="kitdetails.php" style="color:#05ad40;">Do It Yourself Kit</a>: Complete set of components, 1 pendrive(all softwares and explanatory documents),<a href="gifts.php" style="color:red;" > 1 Special Gift </a>
  ...
  <div class="panel panel-default hidden-lg">
    ...
    <div class= "col-xs-12"   style="border-style: solid;  border-color: white ; padding: 0px 0px 0px 0px ; " >
      ...
      <div class= "col-xs-12" style="border-style: solid;  border-color: white ; padding: 10px 10px 10px 10px ; " >
       ...
       <h3 style="font-family: 'Muli', sans-serif;" ><?php echo $product_title; ?></h3>
  ...
  <div style="font-family: 'Muli', sans-serif;">
       <a  href="kitdetails.php " style="color:#0070FF;  ">ReadyMade Kit</a>: Plug and play set, 1 pendrive(all softwares and explanatory documents),<a href="gifts.php "style="color:red;" > 1 Special Gift </a><br>
        ...
        <br>
        <strong style="font-size:25px;font-family: 'Muli', sans-serif;">₹ <?php echo $single_price; ?></strong>
...
<div style="padding: 20px 20px 20px 20px; float: right; font-family: 'Muli', sans-serif;  ">
...
if ($t > 0) {
 ...
 ?>
    ...
    <button  class="btn btn-primary " > <a href="checkout.php" style="text-decoration: none;color:white; font-family: 'Muli', sans-serif; ">Checkout </a> </button> 
      <br>
     <br>
     <button> <a href="index.php" style="text-decoration: none; color: black; font-family: 'Muli', sans-serif; ">Continue shopping </a> </button> 
